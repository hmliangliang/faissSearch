...
if __name__ == "__main__":
    ...
    parser.add_argument("--nprobe", help="在多少个聚类中进行搜索,其值越大搜索越慢", type=int, default=4)
    parser.add_argument("--dim", help="数据的维数", type=int, default=64)
    parser.add_argument("--file_max_num", help="单个csv文件中写入数据的最大行数", type=int, default=10000000)
